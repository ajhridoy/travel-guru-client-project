...
const Signup = () => {
    ...
    return (
      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleSubmit} className="w-full max-w-md newphormism p-4">
          ...
          <div class="relative flex items-center mt-8">
                ...
                <input type="text" name="name" className="block w-full py-3 text-gray-700 bg-white border rounded-md px-11  focus:border-blue-400  focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username" required/>
            </div>
          ...
          <div className="mt-6">
            ...
            <Link
              href="#"
              className="flex items-center justify-center px-6 py-3 mt-4 text-white hover:text-black transition-colors duration-300 transform border rounded-lg bg-gray-500 hover:bg-gray-50"
            >
